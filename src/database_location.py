...
class ProjectDatabaseLoc:
    ...
    def __init__(self, project_name: str):
        ...
        # ------------------------------- Copenhagen -------------------------------#
            ...
            self.survey_d932.d932_sheet = [r"Result Final", r"D932"]
            self.survey_d932.start_line = [2, 3]
            self.survey_d932.ref_col = [1, 1]
            self.survey_d932.type_col = [4, 2]
            self.survey_d932.track_col = [2, 3]
            self.survey_d932.design_kp_col = [6, 4]
