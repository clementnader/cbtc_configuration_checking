...
if DATABASE_LOC.control_tables_config_ini_file:
    CONFIG_INI_FILE_NAME = DATABASE_LOC.control_tables_config_ini_file
else:
    # CONFIG_INI_FILE_NAME = "control_tables_configuration_bxl.ini"
    CONFIG_INI_FILE_NAME = "control_tables_configuration.ini"
CONFIG_INI_FILE = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..",
