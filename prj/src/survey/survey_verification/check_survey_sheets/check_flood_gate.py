...
def _get_dc_sys_flood_gate_dict(survey_info: dict[str]):
    ...
    for obj_name, obj_val in obj_dict.items():
        ...
        if len(limits) == 2:
            ...
            obj_prefix_1, obj_prefix_2 = get_fg_end_prefixes_order(obj_name, survey_info, left_lim[1], right_lim[1])
...
def get_fg_end_prefixes_order(obj_name: str, survey_info: dict[str],
    ...
    order_polarity = _get_survey_obj_order_pattern(obj_name, survey_info, smaller_kp, larger_kp)
