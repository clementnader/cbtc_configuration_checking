...
SURVEY_TYPES_DICT = {
    "SWP":           {"res_sheet": "Switch",
                      ...
                      "survey_type_names": ["SWP", "SWITCH", "SWITCH_POINT", "SWITCH POINT"]},
    ...
    "PLATFORM":      {"res_sheet": "Platform",
                      ...
                      "survey_type_names": ["PLATFORM", "PLATFORM_END", "PLATFORM END",
    ...
    "OSP":           {"res_sheet": None,
                      "survey_type_names": ["OSP", "PAE", "PLATFORM_OSP", "PLATFORM OSP"]},

    "TC":            {"res_sheet": "Block_Joint",
                      "dcsys_sh": DCSYS.CDV,
                      "func": check_joint,
                      "tol": "joint_tolerance",
                      "survey_type_names": ["TC", "TRACK_CIRCUIT", "TRACK CIRCUIT", "TRACK CIRCUITS JOINT",
    ...
    "SIGNAL_BUFFER": {"res_sheet": "Buffer",
                      ...
                      "survey_type_names": ["SIGNAL_BUFFER", "SIGNAL BUFFER", "BUFFER", "BS"]},
    ...
    "VERSION TAG":   {"res_sheet": None,
                      "survey_type_names": ["VERSION_TAG", "VERSION TAG", "VERSION_TAGS", "VERSION TAGS",
    ...
    "FLOOD_GATE":    {"res_sheet": "FloodGate",
                      ...
                      "survey_type_names": ["FLOOD_GATE", "FLOOD GATE", "FLOODGATE", "FLOODGATES"]},
}
