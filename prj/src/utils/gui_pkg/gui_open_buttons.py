...
__all__ = ["add_dc_sys_open_button", "add_cctool_oo_open_button", "add_c11_open_button"]
...
def add_c11_open_button(frame: tkinter.Frame, ref_row: int, bg: str = None) -> tkinter.StringVar:
    title_text = "C11_D470: "
