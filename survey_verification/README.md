...
- **Columns B and C** contain the positioning (track, KP) collected from the DC_SYS.


- **Columns D and E** contain the positioning (track, KP) collected from the survey file(s).
