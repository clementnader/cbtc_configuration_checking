...
def min_dist_between_two_last_signals_before_cbtc_territory_exit(same_dir: bool = True):
    ...
    for i, sig1 in enumerate(sig_before_cbtc_exit):
        print_log_progress_bar(i, nb_sig_before_exit, f"processing distance between {sig1} and previous "
                               f"last signal")
    ...
    print_log_progress_bar(nb_sig_before_exit, nb_sig_before_exit, "processing distances between two last "
