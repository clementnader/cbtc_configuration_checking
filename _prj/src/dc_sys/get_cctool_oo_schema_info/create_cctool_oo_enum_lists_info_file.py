...
def get_clean_value(value: str):
    value = value.replace(" ", "_")  # remove special character
    value = value.replace("?", "Question_Mark")  # remove special character
    value = value.replace("->", "_")  # remove special characters
    return value
