...
def launch_translation_function(window: tkinter.Tk,
    ...
    if are_control_tables_ready(control_tables_config_ini_file, control_tables_loc_dict, control_table_type):
...
def is_everything_ready(dc_sys_directory: tkinter.StringVar, dc_sys_file_name: tkinter.StringVar,
    ...
    if not are_control_tables_ready(control_tables_config_ini_file,
...
def are_control_tables_ready(control_tables_config_ini_file: tkinter.StringVar,
                             control_tables_loc_dict: dict[str, dict[str, tkinter.StringVar]],
    ...
    if control_tables_config_ini_file.get() == "":
        print_log(f"Control Tables Configuration .ini file is not selected.")
        test = False
