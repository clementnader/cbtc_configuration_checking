...
__all__ = ["create_empty_verif_sheet",
           "NAME_COL", "TRACK_COL", "START_KP_COL", "END_KP_COL", "AUTOMATIC_COMMENTS_COL",
...
def _set_columns_width(ws: xl_ws.Worksheet):
    ws.column_dimensions[NAME_COL].width = 45
...
def _write_columns_title(ws: xl_ws.Worksheet, row: int, dc_sys_sheet_name: str):
    # Object name
    create_merged_cell(ws, f"{dc_sys_sheet_name} Name", start_row=row, end_row=row+1,
                       start_column=NAME_COL, end_column=NAME_COL,
